  ...
  const handleSubmit = async () => {
    ...
    try {
      const res = await apiFetch(
        mode === "login" ? ENDPOINTS.AUTH.LOGIN : ENDPOINTS.AUTH.REGISTER,
        {
          method: "POST",
    ...
    >
      ...
      <div
        style={{
          ...
          pointerEvents: "none",
          background:
            "radial-gradient(ellipse 60% 40% at 50% 0%, #4f7cff0d 0%, transparent 70%)",
        }}
      />
      ...
      <div style={{ width: "100%", maxWidth: 400, position: "relative" }}>
        ...
        <div className="flex flex-col items-center mb-8 gap-3">
          ...
          <div className="text-center">
            ...
            <p className="text-sm mt-1" style={{ color: "#4a5168" }}>
          ...
          >
            {["login", "register"].map((m) => (
              <button
                ...
                className="flex-1 py-2 rounded-md text-sm font-bold transition-all duration-150 capitalize"
                style={{
                  background: mode === m ? "#1f2330" : "transparent",
                  color: mode === m ? "#e8eaf0" : "#4a5168",
                  border:
                    mode === m ? "1px solid #2a2f3d" : "1px solid transparent",
                  cursor: "pointer",
                }}
              >
        ...
        {/* Footer */}
        <p className="text-center text-xs mt-5" style={{ color: "#4a5168" }}>
